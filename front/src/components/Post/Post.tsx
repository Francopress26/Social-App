...
import { addPostLike,clearDetail, getDetailPost, putLiked, putUnliked } from '../../state/reducers/userSlice';

const Post = (post:PostI) => {


  const[liked,setLiked]=useState(post.liked) // Esto deberia ser el estado del reducer ? O ya lo traigo desde el back
  ...
  return (
    <div>
      <div className=" relative group">
        ...
        {post.description && (
          <div className="opacity-0 group-hover:opacity-100 duration-300 absolute inset-x-0 w-14/12 ml-4  h-2/4 bottom-2    bg-black bg-opacity-70 text-white font-semibold text-center">
      ...
      <div className="flex justify-between">
        ...
        <div className="flex">
          ...
          <button onClick={(e) => handleLike(e)}>
            {liked ? (
              <FcLike className="mr-4 " size={40} />
            ) : (
              <FcLikePlaceholder className="mr-4 " size={40} />
            )}
          </button>
